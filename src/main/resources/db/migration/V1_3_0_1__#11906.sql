...
alter table solicitacao_ramal_historico add constraint FK_SOLICITACAO_RAMAL_HISTORICO_SOLICITACAO_RAMAL foreign key (fk_solicitacao_ramal) references solicitacao_ramal
alter table solicitacao_ramal_historico add constraint FK_SOLICITACAO_RAMAL_HISTORICO_USUARIO foreign key (fk_usuario) references usuario

create sequence seq_solicitacao_ramal_historico start with 1 increment by 1
