...
BEGIN
    ...
    IF QTD = 0 THEN
        ...
        INSERT INTO CARGO (ID, CODIGO, NOME, SITUACAO, FK_NIVEL) VALUES (505, 'APROVADOR_PROJETOS_1', 'Aprovador de Projetos 1', 'A', 2);
        INSERT INTO CARGO (ID, CODIGO, NOME, SITUACAO, FK_NIVEL) VALUES (506, 'APROVADOR_PROJETOS_2', 'Aprovador de Projetos 2', 'A', 2);
