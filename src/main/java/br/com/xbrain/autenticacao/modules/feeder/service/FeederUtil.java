...
public class FeederUtil {
    ...
    public static final Integer FUNCIONALIDADE_TRABALHAR_ALARME_ID = 20100;
    ...
    public static final List<Integer> FUNCIONALIDADES_FEEDER_PARA_MSO_RESIDENCIAL = List.of(15000, 15001, 15002, 15003,
        15006, 15007, 15008, 15009, 15010, 15011, 15012, 15013, 15014, 20007, 20018, 20008, 20100, 20101, 20102, 20019,
        20020, 20103, 20104);
    public static final List<Integer> FUNCIONALIDADES_FEEDER_PARA_COLABORADORES_AA_RESIDENCIAL = List.of(20018, 20101,
        20102, 20104);
    ...
    public static final List<CodigoCargo> CODIGOS_CARGOS_COLABORADORES_FEEDER_RESIDENCIAL =
        List.of(AGENTE_AUTORIZADO_SOCIO, AGENTE_AUTORIZADO_SOCIO_SECUNDARIO, AGENTE_AUTORIZADO_BACKOFFICE_TELEVENDAS,
            AGENTE_AUTORIZADO_BACKOFFICE_D2D, AGENTE_AUTORIZADO_BACKOFFICE_TEMP,
            AGENTE_AUTORIZADO_BACKOFFICE_TELEVENDAS_RECEPTIVO, AGENTE_AUTORIZADO_GERENTE, AGENTE_AUTORIZADO_COORDENADOR);
