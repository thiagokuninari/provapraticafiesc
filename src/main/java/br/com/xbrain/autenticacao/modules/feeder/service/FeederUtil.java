...
public class FeederUtil {
    ...
    public static final List<CodigoCargo> CARGOS_BACKOFFICE = List.of(AGENTE_AUTORIZADO_BACKOFFICE_TELEVENDAS,
        AGENTE_AUTORIZADO_BACKOFFICE_D2D, AGENTE_AUTORIZADO_BACKOFFICE_TEMP, AGENTE_AUTORIZADO_BACKOFFICE_TELEVENDAS_RECEPTIVO,
        AGENTE_AUTORIZADO_GERENTE, AGENTE_AUTORIZADO_COORDENADOR);
    ...
    public static final List<CodigoCargo> CARGOS_SOCIO_SECUNDARIO = List.of(AGENTE_AUTORIZADO_SOCIO_SECUNDARIO);
