...
public class FeederUtil {
    ...
    public static final List<Integer> FUNCIONALIDADES_FEEDER_PARA_MSO_RESIDENCIAL = List.of(15000, 15001, 15002, 15003,
        15006, 15007, 15008, 15009, 15010, 15011, 15012, 15013, 15014, 20007, 20018, 20008, 20100, 20101,20019, 20020);
    public static final List<Integer> FUNCIONALIDADES_FEEDER_PARA_COLABORADORES_AA_RESIDENCIAL = List.of(20018, 20100);
