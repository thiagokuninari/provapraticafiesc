...
public class SiteControllerTest {
    ...
    @SneakyThrows
    @WithAnonymousUser
    public void exportarCsv_deveRetornarOK_quandoNaoPassarToken() {
    ...
    @SneakyThrows
    @WithAnonymousUser
    public void getAllAtivos_deveRetornarOK_quandoNaoPassarToken() {
    ...
    @SneakyThrows
    @WithAnonymousUser
    public void getById_deveRetornarOK_quandoNaoPassarToken() {
    ...
    @SneakyThrows
    @WithAnonymousUser
    public void buscarSitesVinculadosAoUsuarioLogado_deveRetornarOk_quandoNaoPassarToken() {
    ...
    @SneakyThrows
    @WithAnonymousUser
    public void adicionarDiscadora_deveRetornarOk_quandoNaoPassarToken() {
    ...
    @SneakyThrows
    @WithAnonymousUser
    public void removerDiscadora_deveRetornarOk_quandoNaoPassarToken() {
        var umSiteDiscadoraRequest = new SiteDiscadoraRequest();
