...
public class UsuarioPredicateHelper {
    ...
    public static UsuarioPredicate umVendedoresFeederPredicateComSocioPrincipal(List<Integer> ids) {
    ...
    public static UsuarioPredicate umVendedoresFeederPredicateSemSocioPrincipal(List<Integer> ids) {
        var predicate = new UsuarioPredicate();
