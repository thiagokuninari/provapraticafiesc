...
public class SolicitacaoRamalHelper {
    public static SolicitacaoRamalDadosAdicionaisAaResponse umaSolicitacaoRamalResponse() {
        return SolicitacaoRamalDadosAdicionaisAaResponse.builder()
            .discadora("teste discadora")
            .socioPrincipal("teste socioPrincipal")
            .usuariosAtivos(123)
            .quantidadeRamais(33)
            .agenteAutorizadoRazaoSocial("teste agenteAutorizadoRazaoSocial")
            .build();
    }
