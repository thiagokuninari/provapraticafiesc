...
public class UnidadesNegocio {
    ...
    public static final UnidadeNegocio UNIDADE_RESIDENCIAL_E_COMBOS = unidadeNegocio(2, "Residencial e Combos", RESIDENCIAL_COMBOS);
    public static final UnidadeNegocio UNIDADE_XBRAIN = unidadeNegocio(3, "Xbrain", XBRAIN);
    public static final UnidadeNegocio UNIDADE_CLARO_RESIDENCIAL = unidadeNegocio(4, "Claro Residencial", CLARO_RESIDENCIAL);
